...
@import url('https://fonts.googleapis.com/css2?family=Noto+Sans+JP:wght@300;400;500;700&display=swap');
      ...
      .img_picture{
        padding-bottom: 2.5rem;
          img{
            ...
            opacity: 0;
            transform:perspective(400px)  scale3d(0.9,0.9,0.9)  translateY(5rem)  rotateX(-4deg);
          }
            & .isShowAnime{
 ...
 //画像リストの出現
    ...
    0%{-webkit-transform:perspective(400px)  scale3d(0.9,0.9,0.9)  translateY(5rem)  rotateX(-4deg);
       transform:perspective(400px)  scale3d(0.9,0.9,0.9)  translateY(5rem)  rotateX(-4deg);
       opacity: 0;
