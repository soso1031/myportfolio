...
@keyframes FlipFadeIn {
  0% {
    -webkit-transform: perspective(400px) scale3d(0.9, 0.9, 0.9) translateY(7rem) rotateX(-3deg);
    transform: perspective(400px) scale3d(0.9, 0.9, 0.9) translateY(7rem) rotateX(-3deg);
    opacity: 0;
  ...
  45% {
    -webkit-transform: perspective(400px) scale3d(0.9, 0.9, 0.9) rotateX(-3deg);
    transform: perspective(400px) scale3d(0.9, 0.9, 0.9) rotateX(-3deg);
    opacity: 1;
    -webkit-transform-origin: top;
    transform-origin: top;
  }
