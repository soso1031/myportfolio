  ...
  .img_list {
    .img_picture {
      ...
      img {
        ...
        /* 奥行表示のためのブロック化 */
        opacity: 0;
        transform: perspective(500px) scale3d(0.93, 0.93, 0.93) translateY(4rem) rotateX(-3deg);
      }
...
@keyframes FlipFadeIn {
  0% {
    -webkit-transform: perspective(500px) scale3d(0.93, 0.93, 0.93) translateY(4rem) rotateX(-3deg);
    transform: perspective(500px) scale3d(0.93, 0.93, 0.93) translateY(4rem) rotateX(-3deg);
    opacity: 0;
  ...
  45% {
    -webkit-transform: perspective(500px) scale3d(0.93, 0.93, 0.93) rotateX(-2.5deg);
    transform: perspective(500px) scale3d(0.93, 0.93, 0.93) rotateX(-2.5deg);
    opacity: 1;
    -webkit-transform-origin: top;
    transform-origin: top;
  }
