  ...
  .img_list {
    .img_picture {
      ...
      img {
        ...
        /* 奥行表示のためのブロック化 */
        opacity: 0;
        transform: perspective(500px) scale3d(0.97, 0.97, 0.97) translateY(1rem) ;
      }
...
@keyframes FlipFadeIn {
  0% {
    -webkit-transform: perspective(500px) scale3d(0.97, 0.97, 0.97) translateY(1rem) ;
    transform: perspective(500px) scale3d(0.97, 0.97, 0.97) translateY(1rem) ;
    opacity: 0;
  ...
  45% {
    -webkit-transform: perspective(500px) scale3d(0.97, 0.97, 0.97) ;
    transform: perspective(500px) scale3d(0.97, 0.97, 0.97) ;
    opacity: 1;
    -webkit-transform-origin: top;
    transform-origin: top;
  }
