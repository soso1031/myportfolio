  ...
  .img_list {
    .img_picture {
      ...
      img {
        ...
        /* 奥行表示のためのブロック化 */
        opacity: 0;
        transform: perspective(100px) scale3d(0.97, 0.97, 0.97) translateY(1rem) rotateX(-2deg);
      }
...
@keyframes FlipFadeIn {
  0% {
    -webkit-transform: perspective(100px) scale3d(0.97, 0.97, 0.97) translateY(1rem) rotateX(-2deg);
    transform: perspective(100px) scale3d(0.97, 0.97, 0.97) translateY(1rem) rotateX(-2deg);
    opacity: 0;
  ...
  45% {
    -webkit-transform: perspective(100px) scale3d(0.97, 0.97, 0.97) rotateX(-1.5deg);
    transform: perspective(100px) scale3d(0.97, 0.97, 0.97) rotateX(-1.5deg);
    opacity: 1;
    -webkit-transform-origin: top;
    transform-origin: top;
  }
  ...
  100% {
    -webkit-transform: perspective(100px) scale3d(1, 1, 1) rotateX(0deg);
    transform: perspective(100px) scale3d(1, 1, 1) rotateX(0deg);
    opacity: 1;
    -webkit-transform-origin: top;
    transform-origin: top;
  }
