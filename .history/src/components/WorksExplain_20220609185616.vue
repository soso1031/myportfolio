  ...
  .img_list {
    .img_picture {
      ...
      img {
        ...
        /* 奥行表示のためのブロック化 */
        opacity: 0;
        transform: perspective(500px) scale3d(0.97, 0.97, 0.97) translateY(4rem) rotateX(-2deg);
      }
...
@keyframes FlipFadeIn {
  0% {
    -webkit-transform: perspective(500px) scale3d(0.97, 0.97, 0.97) translateY(4rem) rotateX(-2deg);
    transform: perspective(500px) scale3d(0.97, 0.97, 0.97) translateY(4rem) rotateX(-2deg);
    opacity: 0;
