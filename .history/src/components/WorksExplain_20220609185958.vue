  ...
  .img_list {
    .img_picture {
      ...
      img {
        ...
        // transform: perspective(500px) scale3d(0.97, 0.97, 0.97) translateY(1rem) rotateX(-2deg);
      }
...
@keyframes FlipFadeIn {
  // 0% {
  //   -webkit-transform: perspective(500px) scale3d(0.97, 0.97, 0.97) translateY(1rem) rotateX(-2deg);
  //   transform: perspective(500px) scale3d(0.97, 0.97, 0.97) translateY(1rem) rotateX(-2deg);
  //   opacity: 0;
